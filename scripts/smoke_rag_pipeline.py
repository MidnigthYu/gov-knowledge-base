"""
RAG 流水线冒烟测试脚本
以模拟政务文档走通文本清洗、分块、向量化、入库、检索全链路
依赖：clean_single_text、TextSplitter、ZhipuEmbeddingClient、ChromaVectorStore
"""
import os
import sys

# 将项目根目录注入 sys.path，保证脚本独立执行时能正确导入 app 包
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from app.utils.text_cleaner import clean_single_text
from app.utils.text_splitter import TextSplitter
from app.client import ZhipuEmbeddingClient
